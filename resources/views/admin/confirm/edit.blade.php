			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<form class="form-horizontal m-t" action="{{url('/admin/confirm/'.$info->id)}}}" method="post" id="commentForm"
							...
							<div class="form-group">
										...
										<div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
											...
											<div class="form-group form-inline">
												<div class="input-group col-md-4">
													...
													<input type="text" class="form-control" value="{{$info->logisticstype}}" name="logisticstype"  aria-describedby="basic-addon3">
												</div>
												<div class="col-md-4">
													<div class="input-group">
														<div class="input-group-prepend">
														...
														<input type="text" class="form-control" value="{{$info->logisticsname}}" name="logisticsname"  aria-describedby="basic-addon3">
													</div>
												</div>
												<div class="col-md-4">
													<div class="input-group">
														...
														<input type="text" class="form-control" value="{{$info->logisticsnum}}" name="logisticsnum" aria-describedby="basic-addon3">
													</div>
												</div>
											</div>
								...
								<div class="card-action">
									...
									<div class="col-sm-4 col-sm-offset-3">
										...
										<!--头部公众-->
										<button class="btn btn-primary" type="submit">提交服务</button>
