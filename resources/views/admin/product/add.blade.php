				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
						 ...
						 <form class="form-horizontal m-t" action="{{url('/admin/product')}}" method="post" id="commentForm" enctype="multipart/form-data">
						...
						<div class="form-group form-inline">
							<div class="input-group col-md-6">
								...
								<input type="title" name="brand" class="form-control" id="email2" placeholder="请输入产品品牌~">
							</div>
							<div class="col-md-6">
								<div class="input-group">
									<label for="email2">商品型号：</label>
									<input type="title" name="model" class="form-control" id="email2" placeholder="请输入产品型号~">
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="introduction" name="introduction" class="form-control" id="email2" placeholder="请输入产品简介~">
						</div>
						<div class="form-group form-inline">
							<label for="inlineinput" class="col-md-3 col-form-label">产品库存</label>
							<div class="col-md-9 p-0">
								<input type="inventory" name="inventory" class="form-control input-full" id="inlineinput" placeholder="请输入产品库存">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<textarea name="details" style="height: 500px;" id="editor" rows="8"></textarea>
						</div>
