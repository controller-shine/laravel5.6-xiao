			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<form class="form-horizontal m-t" action="{{url('/admin/ads/'.$info->id)}}}" method="post" id="commentForm"
						 enctype="multipart/form-data">
							<div class="form-group">
								<label for="exampleFormControlSelect1">广告位置</label>
							...
							<div class="form-group">
								<label for="email2">广告链接</label>
								 <div class="input-group mb-3">
								 	<div class="input-group-prepend">
								 			<span class="input-group-text" id="basic-addon3">https://</span>
								 	</div>
								 	<input type="text" value="{{$info->link}}" name="link" class="form-control" id="basic-url" placeholder="请输入广告链接~">
								 </div>
							</div>
							<div class="form-group">
								<label for="email2">发布者</label>
								<input type="author" value="{{$info->author}}" name="author" class="form-control" id="email2" placeholder="请输入产品标题~">
							</div>
