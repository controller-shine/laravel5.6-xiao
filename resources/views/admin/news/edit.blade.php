			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<form class="form-horizontal m-t" action="{{url('/admin/news/'.$info->id)}}}" method="post" id="commentForm"
						 enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="title" value="{{$info->introduction}}" name="introduction" class="form-control" id="email2"
								 placeholder="请输入产品标题~">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea name="comment" style="height: 500px;" id="editor" rows="8">{!!$info->comment!!}</textarea>
							</div>
