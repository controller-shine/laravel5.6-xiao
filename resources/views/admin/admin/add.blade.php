			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<form class="form-horizontal m-t" action="{{url('/admin/admin')}}" method="post" id="commentForm" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="title" name="name" class="form-control" id="email2" placeholder="请输入昵称~">
							</div>
							
							<div class="form-group">
								<label for="email2">密码</label>
								<input type="password" name="password" class="form-control" id="email2"
								 placeholder="请输入密码~">
							</div>
							
							<div class="form-group">
								<label for="email2">确认密码</label>
								<input type="password" name="repassword" class="form-control" id="email2"
								 placeholder="请确认密码~">
							</div>
							
							<div class="form-group">
								<label for="email2">邮箱</label>
								<input type="author" name="email" class="form-control" id="email2" placeholder="请输入产品标题~">
							</div>
							
							<div class="form-group ">
								<label for="exampleFormControlFile1">头像</label>
								<input type="file" name="img" class="form-control-file " id="exampleFormControlFile1" multiple="multiple">
							</div>
