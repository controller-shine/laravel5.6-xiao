			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							<form class="form-horizontal m-t" action="{{url('/admin/cates/'.$info->id)}}" method="post" id="commentForm">
								
								<div class="form-group">
									<label for="solidInput">分类名称</label>
										<input type="text"  name="name" value="{{$info['name']}}" class="form-control input-solid" id="solidInput" placeholder="请输入分类名称">
								</div>	
								<div class="form-group">
									<label for="solidSelect">父级产品</label>
